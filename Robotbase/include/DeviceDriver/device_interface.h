 ...
 * @return char* 子设备名称地址
 */
const char* get_name_robot_device(const char* device_name, int  );
 ...
 */
int get_custom_device_data(const char* device_name,const char* data_name, void* data, int size);
 ...
 * @return int 0:成功；其他失败
 */
int set_custom_device_data(const char* device_name,const char* data_name, void* data, int size);
